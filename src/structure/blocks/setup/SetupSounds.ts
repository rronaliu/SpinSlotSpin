...
export class SetupSounds extends Block {
    ...
    private setupSounds(): void {
        ...
        import('@pixi/sound').then(({ sound }) => {
            ...
            // BUTTON SFX
            sound.add('UI-pick', resolveAssetUrl(
            ...
            //MUSIC
            sound.add('music-1', resolveAssetUrl(
            ...
            //REEL SFX
            sound.add('reel-thud', resolveAssetUrl(
